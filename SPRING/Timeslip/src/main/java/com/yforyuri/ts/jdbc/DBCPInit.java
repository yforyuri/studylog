...
public class DBCPInit extends HttpServlet{
	...
	private void loadJdbcDriver() {
		...
		try {
			...
			System.out.println("connect mysql Driver");
	...
	private void initConnectionPool() {
		try{
			String jdbcUrl = "jdbc:mysql://localhost:3306/project?Unicode=true&characterEncoding=utf8&serverTimezone=UTC";
			...
			System.out.println("connection pool 등록");
