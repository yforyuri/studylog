...
//	JdbcTemplate
	...
	public ListViewData getListData(
		...
		ListViewData listData = new ListViewData();
			...
			// 2. id 로 검색 : where  like id '%?%'
			// 3. name 으로 검색 : where like name '%?%'
			// 4. id 또는 name :  where like name '%?%' or like id '%?%'
	...
	public ListViewData getListData(int currentPageNumber, SearchParam searchParam) {
		...
		try {
			...
			// 2. id로 검색 : where like id '%?%'
			// 3. name으로 검색 : where like name '%?%'
			// 4. id 또는 name : where like name '%?%' or like id '%?%'
